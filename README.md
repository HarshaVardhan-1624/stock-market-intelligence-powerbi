...
1.Year Slicer — Filter by 2024 or 2025.

2.Ticker Slicer — Filter by individual stocks (AAPL, BAC, DIS, GS, AMZN, CVX, GOOGL, JNJ, and more).

3.Sector Slicer — Filter by Communication, Consumer Cyclical, Consumer Staples, Energy, Financial, Healthcare, Technology.

How to Use:

1.Open in Power BI: Open the .pbix file in Power BI Desktop.

2.Connect Data: Connect your own data or use the provided sample data.

3.Explore and Analyze: Interact with the dashboard to explore insights and trends.

4.Customize: Customize visualizations and metrics based on your needs.

5.Use the slicers (Year, Ticker, Sector) to explore the data interactively
